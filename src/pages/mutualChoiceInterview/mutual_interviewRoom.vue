  ...
  <div class='interviewRoom'>
    <van-sticky>
        ...
        <div class="roomTitle">
            ...
            <div class="companyDesc">
              <img class="companyImg" v-if="companyLogo" :src="companyLogo" alt="">
              <img class="companyImg"  v-else src="@/assets/img/companyLogo.png" alt="">
        ...
        <div  v-if="caseInfoList.length>0" style="padding:0 20px 10px" class="jobInterview">面试岗位</div>
    </van-sticky>
    <div style="padding:0 20px 0">     
     ...
     <van-popup v-model="show" position="bottom" :style="{ height: '70%' }">
       ...
       <div v-html="jobDetail.positionDesc" class="jobDesc">  </div>
       <!-- <div class="jobDemand">
         职位要求：
       </div>
...
<script>
import {selectInterviewRoomDetailForC,getPositionInfoByEhireJobId,getPrd} from './api/mutualChoiceInterview.js'
   ...
   methods:{
    ...
    async handleApply(btnType){
      ...
      if(this.checkedFlag){
        ...
        // 线上地址：
        let openUrl=`https://xym.51job.com/personal/personal_applyjob.aspx?ctmid=${this.ctmId}&jobid=${this.checkedItem.ehireJobId}&prd=xyb_02&prp=&cd=&cp=&ruid=&backurl=${window.location.href}`
        //  开发测试地址：
        // let openUrl=`http://sh-dev-176.51job.com/eHirePlusWebApp/htdocs/personal/personal_applyjob.aspx?ctmid=${this.ctmId}&jobid=${this.checkedItem.ehireJobId}&prd=xyb_02&prp=&cd=&cp=&ruid=&backurl=${window.location.href}`
